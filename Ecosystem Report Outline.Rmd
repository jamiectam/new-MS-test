...
Text about the indicators how to interpret them with more detailed graphs. Relevance to the management/ecological objective 
...
Conservation of Biodiversity: Do not cause unacceptable reduction in biodiversity in order to preserve the structure and natural resilience of the ecosystem.
i.	Biodiversity
...
Habitat: Prevent unacceptable modification to habitat in order to safeguard the biological, physical and chemical properties of the ecosystem that allow species to complete their life cycle.
i.	Habitat 
1.	Biogenic
...
Key Signals within the Fishery: Maintain fishing pressure at levels consistent with the ecosystem's ability to recover from it.
i.	Fishing Pressure 
...
Social and Economic Considerations: Ensure that the ecosystem continues maintain the prosperity, happiness and wellbeing of individuals and communities that derive a livelihood from it. 
i.	Commercial 
1.	Total Revenue
...
Management: Fish sustainably while minimizing adverse impacts on non-target species.
